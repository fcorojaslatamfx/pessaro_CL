    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      >
        <div className="container-wide flex items-center h-full">
          ...
          {/* Mobile Toggle */}
          <button 
            className="lg:hidden touch-target p-2 text-white hover:bg-white/10 rounded-md transition-colors" 
          ...
          {isMenuOpen && (
            <>
              ...
              <motion.div 
                ...
                className="lg:hidden bg-blue-900/98 backdrop-blur-md border-b border-blue-800 relative z-50 shadow-2xl safe-area-bottom"
            >
              <nav 
