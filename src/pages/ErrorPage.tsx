...
import { AlertTriangle, Home, RefreshCw, Send, Gift, CheckCircle } from 'lucide-react';
...
import SurpriseGiftPopup from '@/components/SurpriseGiftPopup';
...
const ErrorPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Mostrar popup de regalo después de 1 segundo
      setTimeout(() => {
  ...
  const handleGiftPopupClose = () => {
    ...
    // Redirigir a inicio después de cerrar el popup
    setTimeout(() => {
      navigate(ROUTE_PATHS.HOME);
    }, 500);
  };
                ...
                {isSubmitted ? (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-center gap-2 text-primary">
                      ...
                      <span className="font-semibold">Preparando tu regalo sorpresa...</span>
                    </div>
                  </motion.div>
                ) : (
